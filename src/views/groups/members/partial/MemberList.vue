          ...
          >
            ...
            <template slot="actions" scope="props">
              <div class="custom-actions">
                <button class="btn btn-primary btn-sm" @click="onSelectData(props.rowData)">Çıkar</button>
              </div>
            </template>
          </vuetable>
  ...
  export default {
    ...
    methods: {
      ...
      async onFetchApi(apiUrl, httpOptions) {
        ...
        var data;
        data = this.$store.dispatch("fetchGroupHasMembers", {
          httpOpt: httpOptions,
          ...this.query
        });
