    ...
    <div>
          <ATabs :value="'Üye Listesi'">
            ...
            <ATabPane @getId="getId" :id="1" :title="'Üye Listesi'">
              <MemberList :groupId="groupId" @removemember="removeMember" :state="state" :type="'students'"></MemberList>
            </ATabPane>
            <ATabPane @getId="getId" :id="2" :title="'Yeni Üye'">
              <AssignMember :groupId="groupId" @assignmember="assignMember" :state="state" :type="'students'"></AssignMember>
            </ATabPane>
          </ATabs>
    </div>
</template>
